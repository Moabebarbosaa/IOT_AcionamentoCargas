...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void ligarDesligarQuarto(bool value) {
    setState(() {
      _quarto = value;
      print("FIREBASE QUARTO");
      databaseReference
          .child("Leds")
          .update({'Quarto': _quarto == true ? "Q" : "q"});
      _favBox.put("Quarto", _quarto ? "Q" : "q");
    });
  }

  void ligarDesligarSala(bool value) {
    setState(() {
      _sala = value;
      databaseReference
          .child("Leds")
          .update({'Sala': _sala == true ? "S" : "s"});
      _favBox.put("Sala", _sala ? "S" : "s");
      print("FIREBASE SALA");
    });
  }

  void ligarDesligarCozinha(bool value) {
    setState(() {
      _cozinha = value;
      databaseReference
          .child("Leds")
          .update({'Cozinha': _cozinha == true ? "C" : "c"});
      _favBox.put("Cozinha", _cozinha ? "C" : "c");
      print("FIREBASE COZINHA");
    });
  }

  void ligarDeslisgarBanheiro(bool value) {
    setState(() {
      _banheiro = value;
      databaseReference
          .child("Leds")
          .update({'Banheiro': _banheiro == true ? "B" : "b"});
  ...
  Widget build(BuildContext context) {
    print("dlksajdskljadhksjahdjksa $_text");
    _text = _text.toLowerCase();
    if (_text == 'ligar quarto') {
      ligarDesligarQuarto(true);
      _text = '';
    } else if (_text == 'desligar quarto') {
      ligarDesligarQuarto(false);
      _text = '';
    } else if (_text == 'ligar sala') {
      ligarDesligarSala(true);
      _text = '';
    } else if (_text == 'desligar sala') {
      ligarDesligarSala(false);
      _text = '';
    } else if (_text == 'ligar cozinha') {
      ligarDesligarCozinha(true);
      _text = '';
    } else if (_text == 'desligar cozinha') {
      ligarDesligarCozinha(false);
      _text = '';
    } else if (_text == 'ligar banheiro') {
      ligarDeslisgarBanheiro(true);
      _text = '';
    } else if (_text == 'desligar banheiro') {
      ligarDeslisgarBanheiro(false);
      _text = '';
    }
                          ...
                          Container(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                ...
                                databaseReference
                                    .child("Leds")
                                    .update({'Banheiro': lista[0]});
                                databaseReference
                                    .child("Leds")
                                    .update({'Cozinha': lista[1]});
                                databaseReference
                                    .child("Leds")
                                    .update({'Quarto': lista[2]});
                                databaseReference
                                    .child("Leds")
                                    .update({'Sala': lista[3]});
                              },
